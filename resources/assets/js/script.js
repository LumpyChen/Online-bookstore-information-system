...
$(function(){
	...
	$('#orders').click(function orders(){
		$("#orders").delay(100).attr('action', '{{ URL("orders/") }}');
	});
	$('#order-detail .fa-plus-circle').avgrund({
		...
		onBlurContainer: '.container',
		template: 
		'<form method="POST" id="order-details">' +
		'<h2>记录新订单明细</h2>' +
	...
	$('#orders').click(function orders_details(){
		$("#orders_details").delay(100).attr('action', '{{ URL("orders_details/") }}');
	});
	...
	$('#orders').click(function books(){
		$("#books").delay(100).attr('action', '{{ URL("books/") }}');
	});
	$('#repository .fa-plus-circle').avgrund({
		...
		onBlurContainer: '.container',
		template: 
		'<form method="POST" id="repositories" ><input type="hidden" name="_token" value="{{ csrf_token() }}" />' +
		'<h2>增添新仓库</h2>' +
	...
	$('#orders').click(function repositories(){
		$("#repositories").delay(100).attr('action', '{{ URL("repositories/") }}');
	});
	$('#repository-detail .fa-plus-circle').avgrund({
		...
		onBlurContainer: '.container',
		template: 
		'<form method="POST" id="repository-details"><input type="hidden" name="_token" value="{{ csrf_token() }}" />' +
		'<h2>记录新仓库明细</h2>' +
	...
	$('#orders').click(function repository_details(){
		$("#repository_details").delay(100).attr('action', '{{ URL("repository_details/") }}');
	});
	$('.user .fa-plus-circle').avgrund({
		...
		onBlurContainer: '.container',
		template: 
		'<form method="POST" id="users" ><input type="hidden" name="_token" value="{{ csrf_token() }}" />' +
		'<h2>增添新用户</h2>' +
	...
	$('#orders').click(function users(){
		$("#users").delay(100).attr('action', '{{ URL("users/") }}');
	});
	$('.keeper .fa-plus-circle').avgrund({
		...
		onBlurContainer: '.container',
		template: 
		'<form method="POST" id="keepers" ><input type="hidden" name="_token" value="{{ csrf_token() }}" />' +
		'<h2>增添新管理员</h2>' +
	...
	$('#keepers').click(function keepers(){
		$("#keepers").delay(100).attr('action', '{{ URL("keepers/") }}');
	});
	$('#logistic .fa-plus-circle').avgrund({
		...
		onBlurContainer: '.container',
		template: 
		'<form method="POST" id="logistics" ><input type="hidden" name="_token" value="{{ csrf_token() }}" />' +
		'<h2>增添新物流公司</h2>' +
	...
	$('#keepers').click(function logistics(){
		$("#logistics").delay(100).attr('action', '{{ URL("logistics/") }}');
	});
});
